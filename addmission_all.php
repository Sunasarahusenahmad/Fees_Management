                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table border mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $select_query = "SELECT  `register_no`, `roll_no`, `student_name`, `father_contact_no_2`, `student_address`, `courses`, `status` FROM `addmission` WHERE CONCAT(roll_no, student_name, father_contact_no_2, student_address, courses) LIKE '%$filtervalues%' ";
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                            ...
                                                            <a href="addmission_active_deactive_complete.php?register_no=<?php echo $data['register_no'] ?>&status=1 "><button><i class="fa fa-check text-success"></i></button> </a>

                                                        <?php
                                                        } else if ($data['status'] == 1) {
                                                        ?>

                                                            <a href="addmission_active_deactive_complete.php?register_no=<?php echo $data['register_no'] ?>&status=2"> <button><i class="fa fa-times text-danger"></i></button> </a>

                                                        <?php
                                                        } else {
                                                        ?>

                                                            <a href="addmission_active_deactive_complete.php?register_no=<?php echo $data['register_no'] ?>&status=0"> <button><i class="fa fa-copyright text-primary"></i></button> </a>
