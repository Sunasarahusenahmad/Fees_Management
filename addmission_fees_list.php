                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-header text-center" style="font-weight: bolder;"> Addmission Fees </div>
                            <div class="card-body">
                                    ...
                                    <table class="table border mb-0">
                                        <thead class="table-light fw-semibold">
                                            <tr class="align-middle">
                                                ...
                                                <th class="text-center">Your Course</th>
                                                <th class="text-center">Addmission Fees</th>
                                                <th class="text-center">Pay Fees</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            ...
                                            $select_query = "SELECT  `register_no`, `roll_no`, `student_name`, `courses`, `joining_date`, `addmission_fees` FROM `addmission` ";
                                            ...
                                            ?>
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center"> <?= $data['joining_date']; ?> </td>

                                                    <td class="text-center"> <?= $data['courses']; ?> </td>
