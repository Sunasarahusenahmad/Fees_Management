        ...
        <div class="body flex-grow-1 px-3">
            <div class="container-lg">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card mb-4">
                            <div class="card-header text-center" style="font-weight: bolder;">Inquiry List</div>
                            <div class="card-body">

                                <div class="table-responsive">


                                    <button type="button" class="btn btn-primary float-end mb-2 rounded-0"><a href="inquiry.php" class="text-light" style="text-decoration: none;"><i class="fa fa-plus"></i> Add Inquiry</a></button>
                                    ...
                                    <table class="table border mb-0 ">
                                        ...
                                        <tbody>
                                            ...
                                            $select_query = "SELECT id, student_name, surname, contact_no_2, address, email FROM `inquiry` ";
                                            ...
                                            ?>
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center"> <?= $data['contact_no_2']; ?> </td>

                                                    <td class="text-center"> <?= $data['address']; ?> </td>

                                                    <td class="text-center"> <?= $data['email']; ?> </td>

                                                    <td class="text-center"> <button data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit"><a href="inquiry_edit.php?id=<?php echo $data['id']; ?>" class="text-dark"><i class="fa fa-edit"></i></a></button> </td>

                                                    <td class="text-center"><span type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" data-bs-toggle="tooltip" title="Delete"><button><i class="fa fa-trash"></i></button></span> </td>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-primary text-light rounded-0"><a href="inquiry_delete.php?id=<?php echo $data['id']; ?>" style="color: #EBEDEF; text-decoration: none;">Delete</a></button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <!-- <form class="row g-3" method="POST">
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputCity" class="form-label">Contact No 2</label>
                                        <input type="text" name="contact_no_2" class="form-control" id="inputCity" placeholder="Contact No 2" maxlength="10" required>
                                    </div>
                                    <div class="col-md-4">
                                    ...
                                    <div class="col-md-4">
                                        <label for="inputPassword4" class="form-label">Previous School Name</label>
                                        <input type="text" name="previous_school_name" class="form-control" id="inputPassword4" placeholder="Previous School Name" required>
                                    </div>
                                    <div class="col-md-4">
