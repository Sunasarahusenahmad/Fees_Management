                                                ...
                                                <div class="card mb-4 mx-4">
                                                    <div class="card-body p-4">
                                                        <form action="" method="POST">
                                                            ...
                                                            $roll_no_update = $_GET['roll_no'];
                                                            // echo '<pre>';
                                                            // print_r($roll_no);
                                                            // exit;

                                                            $select_query = "SELECT * FROM `addmission` where roll_no = $roll_no_update ";
                                                            ...
                                                            if (isset($_POST['update'])) {
                                                                ...
                                                                $update_query = "UPDATE `addmission_fees` SET roll_no = '$roll_no', student_name = '$student_name', surname = '$surname', courses = $courses WHERE roll_no = '$roll_no_update' ";
