                                ...
                                <div class="table-responsive">
                                    ...
                                    <table class="table border mb-0">
                                        ...
                                        <tbody>
                                            ...
                                            $select_query = "SELECT  `register_no`, `roll_no`, `student_name`, `father_contact_no_2`, `student_address`, `courses`, `status` FROM `addmission` WHERE status=1 AND CONCAT(roll_no, student_name, father_contact_no_2, student_address, courses) LIKE '%$filtervalues%'";
                                                ...
                                                <tr class="align-middle">
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        ?>
                                                            ...
                                                            <button><i class="fa fa-times text-danger"></i></button>
